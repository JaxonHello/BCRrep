...
# The definition of CDR3 here is the 26 nucleotides upstream of the JH region (J1 to J4)

# Input 
# i) file_seq - name of the file with sequences
# ii) dir_seq - location of the file_seq (path)
# iii) dir_blast - location of the file_blast (path)
# iv) file_blast - name of the file with table
...
file_list <- list.files("C:/Users/Chen-Lab/Desktop/Program/BCR_rep/IgBlast_result/Parse_IgBlast")
for (i in 1:length(file_list)){
  fasta <- paste0(sub("Parse_(.*).txt", "\\1", file_list[i]), ".fasta")
  print(paste0(fasta ,"正在准备添加UMI和CDR3"))
  Extract_UMI_CDR3(fasta, "C:/Users/Chen-Lab/Desktop/Program/BCR_rep/filter_read", 
                   "C:/Users/Chen-Lab/Desktop/Program/BCR_rep/IgBlast_result/Parse_IgBlast",
                   file_list[i])
}

rm(fasta, file_list, i)
